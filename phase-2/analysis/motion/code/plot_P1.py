...
#        original_data_1D = json.load(f)
    ...
    for keypoint in original_data_1A['data']:
        ...
        #wrists_distance_1A.append(keypoint['keypoints_wrists_delta']['wrists_delta'])
        #RWrist_nose_distance_1A.append(keypoint['keypoints_RWrist_nose_delta']['r_wrist_nose_distance'])
        #RWrist_nose_angle_1A.append(keypoint['keypoints_RWrist_nose_distance_angle']['r_wrist_nose_angle_degrees'])
   ...
   #     time_1D.append(keypoint['time'])
       # wrists_distance_1D.append(keypoint['keypoints_wrists_delta']['wrists_delta'])
       # RWrist_nose_distance_1D.append(keypoint['keypoints_LWrist_nose_delta']['r_wrist_nose_delta'])
       # RWrist_nose_angle_1D.append(keypoint['keypoints_LWrist_nose_delta']['r_wrist_nose_angle_degrees'])
    ...
    #    qom_1D.append(keypoint['delta_mavg'])
